...
TextLabel.Text = "Zoomy Gui by ZacBozer"
...
if yes.BackgroundTransparency == 0 then
	local descendants = AccessUI:GetDescendants()
	for index, descendant in pairs(descendants) do
	descendant.BackgroundTransparency = 1
	if descendant.ClassName == "TextButton" or descendant.ClassName == "TextBox" then
		descendant.TextTransparency = 1
	end
	end
	Frameeya.BackgroundTransparency = 0
	TextLabel.TextTransparency = 0
	exitopen.BackgroundTransparency = 0
...
FathomHub.Name = "Fathom Hub"
FathomHub.Parent = ScrollingFrame
FathomHub.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
FathomHub.BorderSizePixel = 0
FathomHub.Position = UDim2.new(0, 0, 0, 300)
FathomHub.Size = UDim2.new(0, 188, 0, 53)
